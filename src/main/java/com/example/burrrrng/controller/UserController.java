...
public class UserController {
    ...
    @PostMapping("/login")
    public ResponseEntity<CommonResDto<UserResponseDto>> loginUser(
    ...
    public ResponseEntity<CommonNoContentResDto> updatePassword(
            @PathVariable Long id,
        ...
        return ResponseEntity.ok().body(new CommonNoContentResDto("비밀번호가 변경되었습니다."));
    }
