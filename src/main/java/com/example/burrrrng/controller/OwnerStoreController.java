...
public class OwnerStoreController {
    ...
    @PostMapping
    public CommonResDto<ResponseOwnerStoreDto> createStore(@RequestBody RequestOwnerStoreDto requestOwnerStoreDto) {
        return ownerStoreService.createStore(requestOwnerStoreDto);
    }
